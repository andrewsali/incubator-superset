...
from superset.models.helpers import AuditMixinNullable, ImportMixin, set_perm, set_perm_db
...
sqla.event.listen(Database, 'after_insert', set_perm_db)
sqla.event.listen(Database, 'after_update', set_perm_db)
